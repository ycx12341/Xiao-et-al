...
mean(bcd_ecm_r1_nonan[,2]) # Avg BCD: 3.408093
...
mean(bcd_ecm_r2_nonan[,2]) # Avg BCD: 2.11247
...
mean(bcd_ecm_mde_r1_nonan[,2]) # Avg BCD: 7.193976
...
mean(bcd_ecm_mde_r2_nonan[,2]) # Avg BCD: 4.776052
...
mean(bcd_ecm_mde_r3_nonan[,2]) # Avg BCD: 2.748202
...
mean(bcd_ecm_mde_r4_nonan[,2]) # Avg BCD: 1.089054
...
mean(bcd_ecm_mde_r5_nonan[,2]) # Avg BCD: 0.3773485
...
mean(bcd_all3_r1_nonan[,2]) # Avg BCD: 3.813652
...
mean(bcd_all3_r2_nonan[,2]) # Avg BCD: 1.905364
...
mean(bcd_all3_r3_nonan[,2]) # Avg BCD: 0.7937083
...
mean(bcd_all3_r4_nonan[,2]) # Avg BCD: 0.3228846
...
mean(bcd_all3_r5_nonan[,2]) # Avg BCD: 0.1817929
...
mean(bcd_all3_r6_nonan[,2]) # Avg BCD: 0.1215096
...
mean(bcd_all3_r7_nonan[,2]) # Avg BCD: 0.0894005
...
mean(bcd_all3_r8_nonan[,2]) # Avg BCD: 0.07065394
...
mean(bcd_all3_r9[,2]) # Avg BCD: 0.05963551
...
mean(paras_all3_r10[,1]) # dn = 0.01079447
mean(paras_all3_r10[,2]) # gamma = 0.05161895
mean(paras_all3_r10[,3]) # eta = 9.850783
mean(paras_all3_r10[,4]) # dm = 0.01000767
mean(paras_all3_r10[,5]) # alpha = 0.09970233
mean(paras_all3_r10[,6]) # rn = 5.245765
